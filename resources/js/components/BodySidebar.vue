    ...
    <div id="sidebar" class="span3">
        <div class="well well-small">
            <ul class="nav nav-list">
                ...
                <li>
                    <a class="totalInCart" href="cart.html"><strong>Total Amount
                            <span class="badge badge-warning pull-right"
                                style="line-height: 18px">$448.42</span></strong></a>
                </li>
            </ul>
        </div>
        ...
        <div class="well well-small alert alert-warning cntr">
            <h2>50% Discount</h2>
            <p>
                only valid for online order. <br /><br /><a class="defaultBtn" href="#">Click here
                </a>
            </p>
        </div>
        <div class="well well-small">
