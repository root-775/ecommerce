    ...
    <div class="span9">
        ...
        <div class="well well-small">
                    ...
                    <div id="myCarousel" class="carousel slide cntr">
                        <div class="carousel-inner">
                            <div class="item active">
                                <a href="#">
                                    <img :src="`${url}/assets/img/a.jpg`" alt="" style="width: 100%" /></a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img :src="`${url}/assets/img/b.jpg`" alt="" style="width: 100%" /></a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img :src="`${url}/assets/img/e.jpg`" alt="" style="width: 100%" /></a>
                            </div>
                        </div>
                ...
                <div class="span7">
                    ...
                    <form class="form-horizontal qtyFrm">
                        ...
                        <p>
                            ...
                            the most successful business spheres.
                            Nowadays the lingerie industry is one of
                            ...
                        </p>
            ...
            <ul id="productDetail" class="nav nav-tabs">
                ...
                <li class="">
                    <a href="#profile" data-toggle="tab">Related Products
                    </a>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="#cat1" data-toggle="tab">Category one</a>
                        </li>
                        <li>
                            <a href="#cat2" data-toggle="tab">Category two</a>
                        </li>
                    </ul>
                </li>
            </ul>
            <div id="myTabContent" class="tab-content tabWrapper">
                ...
                <div class="tab-pane fade" id="profile">
                    <div class="row-fluid">
                        <div class="span2">
                            <img :src="`${url}/assets/img/d.jpg`" alt="" />
                        </div>
                        <div class="span6">
                            <h5>Product Name</h5>
                            <p>
                                Nowadays the lingerie industry is
                                one of the most successful business
                                spheres. We always stay in touch
                                with the latest fashion tendencies -
                                that is why our goods are so
                                popular..
                            </p>
                        </div>
                ...
                <div class="tab-pane fade" id="cat1">
                    <p>
                        ...
                        whatever gluten-free, carles pitchfork
                        biodiesel fixie etsy retro mlkshk vice blog.
                        Scenester cred you probably haven't heard of
                        them, vinyl craft beer blog stumptown.
                        Pitchfork sustainable tofu synth chambray
                        yr.
                    </p>
                    <br />
                    <br />
                    <div class="row-fluid">
                        <div class="span2">
                            <img :src="`${url}/assets/img/b.jpg`" alt="" />
                        </div>
                        <div class="span6">
                            <h5>Product Name</h5>
                            <p>
                    ...
                    <div class="row-fluid">
                        <div class="span2">
                            <img :src="`${url}/assets/img/a.jpg`" alt="" />
                        </div>
                        <div class="span6">
                            <h5>Product Name</h5>
                            <p>
